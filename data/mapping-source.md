...
{name: 'OpenAPI 3 viewer', group: 'ui-components', link: 'https://github.com/koumoul-dev/openapi-viewer) - Browse and test a REST API described with the OpenAPI 3.0 Specification
...
{name: 'Wake Up Billie Joe!', group: 'ui-components', link: 'https://wakeupbilliejoe.com) - A web site countdown to October, based on Green Day's song Wake me up when September Ends. Created using Vue and Firebase.
...
{name: 'vNotes', group: 'ui-components', link: 'https://halfeld.github.io/v-notes/#!/) - Simple and beautiful notepad to Markdown with Vue.js and Local Storage API.
...
{name: 'Vue.js Feed', group: 'ui-components', link: 'https://vuejsfeed.com/) - The latest Vue.js news, tutorials, plugins, and more. Made with Vue.js and Laravel, based on **[Vuedo', group: 'ui-components', link: 'https://github.com/Vuedo/vuedo)**.
...
{name: 'iPrevYou - YouTube™ Player', group: 'ui-components', link: 'https://chrome.google.com/webstore/detail/iprevyou-youtube-player/blijlgfnjhnhmnaldaiienmjggbjhbaa) - A chrome app for watching youtube videos on your desktop.
...
{name: 'vue-mdc', group: 'ui-components', link: 'https://github.com/posva/vue-mdc) - Material Components Web for Vue.js.
...
{name: 'vue-scrollview', group: 'ui-components', link: 'https://github.com/chrishurlburt/vue-scrollview) - A component utilizing scoped slots to detect when a vue component enters and leaves the viewport.
...
{name: 'express-vue', group: 'ui-components', link: 'https://github.com/danmademe/express-vue) - Vue rendering engine for Express.js. Use .Vue files as templates using res.render().
{name: 'vue-grecaptcha', group: 'ui-components', link: 'https://github.com/drozdzynski/vue-grecaptcha) - Google reCAPTCHA for VueJS 2
{name: 'vue-recaptcha', group: 'ui-components', link: 'https://github.com/DanSnow/vue-recaptcha) - Google reCAPTCHA component for Vue.js
{name: 'require-vuejs', group: 'ui-components', link: 'https://github.com/edgardleal/require-vuejs) - RequireJS plugin to async and dynamic load and parse .vue components.
{name: 'facebook-login-vuejs', group: 'ui-components', link: 'https://github.com/iliran11/facebook-login-vue.git) - Vue Component for Authenticating your Facebook App and get the benefits of Facebook Login.
{name: 'vuejs/vuefire', group: 'ui-components', link: 'https://github.com/vuejs/vuefire) - Official Firebase Integration for VueJS
{name: 'vuefire', group: 'ui-components', link: 'https://github.com/nigeltiany/vuefire) - Firebase for VueJS and Vuex
{name: 'vue-runkit', group: 'ui-components', link: 'https://github.com/maple3142/vue-runkit) - RunKit Embed for Vue.js
{name: 'vue-youtube', group: 'ui-components', link: 'https://github.com/anteriovieira/vue-youtube) - Provides a simple layer for you to use your imagination while over the [YouTube IFrame Player API', group: 'ui-components', link: 'https://developers.google.com/youtube/iframe_api_reference). (Compatible with SSR)
{name: 'vue-introjs', group: 'ui-components', link: 'https://github.com/alex-oleshkevich/vue-introjs) - Integrates intro.js step-by-step guide and feature introduction with Vue.js [http://introjs.com/', group: 'ui-components', link: 'http://introjs.com/).

###### Google Analytics

{name: 'vue-ua', group: 'ui-components', link: 'https://github.com/ScreamZ/vue-analytics) - Google Universal Analytics support in Vue.js.
{name: 'vue-analytics', group: 'ui-components', link: 'https://github.com/MatteoGabriele/vue-analytics) - Vue plugin for Google Analytics.
{name: 'vue-gtm', group: 'ui-components', link: 'https://github.com/mib200/vue-gtm) - Vue plugin for Google Tag Manager
...
{name: 'vue-dev-server', group: 'ui-components', link: 'https://github.com/paulpflug/vue-dev-server) - A small development server for building `vue` components.
{name: 'vuepack.org', group: 'ui-components', link: 'http://vuepack.org) - A simple page that allows you to select Vue components and download them as a single minified JS file.
{name: 'Storybook', group: 'ui-components', link: 'https://storybook.js.org) - The UI Development Environment. works with v3.2+ later.
{name: 'Font Awesome Finder', group: 'ui-components', link: 'https://chrome.google.com/webstore/detail/font-awesome-icon-finder/kjejboahkcobalmgldloeinebmbomgog) - Chrome extension to search, preview and choose Font Awesome icons and copy the selected icon HTML code & Unicode to clipboard.
{name: 'vue-dummy', group: 'ui-components', link: 'https://github.com/paulcollett/vue-dummy) - Placeholder Text and Dummy Images as a simple `v-dummy` directive

### Inspect

*Inspecting & debugging*

{name: 'Vue.js devtools', group: 'ui-components', link: 'https://github.com/vuejs/vue-devtools) - Chrome devtools extension for debugging Vue.js applications.
{name: 'DejaVue', group: 'ui-components', link: 'https://github.com/MiCottOn/DejaVue) - Visualization and debugging tool built for Vue.js.
{name: 'vue-clicky', group: 'ui-components', link: 'https://github.com/Herteby/vue-clicky) - Right click any component to show info about it in the console.
{name: 'vuejs-logger', group: 'ui-components', link: 'https://github.com/justinkames/vuejs-logger) - Provides customizable logging functionality for Vue.js.
{name: 'vue-bugsnag', group: 'ui-components', link: 'https://github.com/ankurk91/vue-bugsnag) - Vue.js plugin for [bugsnag', group: 'ui-components', link: 'https://www.bugsnag.com/) error reporting

### Docs

*Create documentation*

{name: 'vue-markdown-loader', group: 'ui-components', link: 'https://github.com/QingWei-Li/vue-markdown-loader) - Convert Markdown file to Vue Component.
{name: 'vue-play', group: 'ui-components', link: 'https://github.com/vue-play/vue-play) - A minimalistic framework for demonstrating your Vue components.
{name: 'vue-styleguide-generator', group: 'ui-components', link: 'https://github.com/shershen08/vue-styleguide-generator) - React inspired style guide generator for Vue.js.
{name: 'CheatSheet', group: 'ui-components', link: 'https://vuejs-tips.github.io/cheatsheet) - Complete Interactive API.
{name: 'propdoc', group: 'ui-components', link: 'https://github.com/propellant/doctor) - A single component that provides simple documentation of Vue.js components/props.
{name: 'Vuex CheatSheet', group: 'ui-components', link: 'https://vuejs-tips.github.io/vuex-cheatsheet) - Complete Interactive Vuex API.
{name: 'vue-styleguidist', group: 'ui-components', link: 'https://github.com/vue-styleguidist/vue-styleguidist) - A style guide generator for Vue components with a living style guide.
### Test

{name: 'avoriaz', group: 'ui-components', link: 'https://github.com/eddyerburgh/avoriaz) - A Vue.js testing utility library.
{name: 'vue-container', group: 'ui-components', link: 'https://github.com/dealloc/vuec) - A simple dependency injection library for Vue 2.
{name: 'vuenit', group: 'ui-components', link: 'https://github.com/jackmellis/vuenit) - Utilities for testing Vue components and directives.
{name: 'vue-unit', group: 'ui-components', link: 'https://github.com/wrseward/vue-unit) - A library for Vue.js that makes it easier to create and unit test components.
{name: 'vue-a2b', group: 'ui-components', link: 'https://github.com/fromAtoB/vue-a2b) - A library for Split Testing with Vue.js. Highly configurable and tiny (1.2k gzipped).
{name: 'vue-test-utils', group: 'ui-components', link: 'https://github.com/vuejs/vue-test-utils) - Official utilities for testing Vue components.

###### Browser-less require

*Load Vue components without browser*

{name: 'vuegister', group: 'ui-components', link: 'https://github.com/iatsiuk/vuegister) - Vuegister (an acronym for vue-register) is a require hook for loading of the Vue.js single-file components (or .vue files).
{name: 'vue-node', group: 'ui-components', link: 'https://github.com/knpwrs/vue-node) - Load vue components in node.
...
{name: 'language-vue@atom.io', group: 'ui-components', link: 'https://github.com/hedefalk/atom-vue) - Vue component file syntax for Atom.
{name: 'language-vue-component@atom.io', group: 'ui-components', link: 'https://github.com/CYBAI/language-vue-component) - Adds syntax highlighting to Vue Component files in Atom.
{name: 'vue-autocomplete@atom.io', group: 'ui-components', link: 'https://github.com/ealves-pt/atom-vue-autocomplete) - Vue.js 1.0+ autocomplete for Atom.
{name: 'vue-snippets@atom.io', group: 'ui-components', link: 'https://github.com/ealves-pt/atom-vue-snippets) - Atom snippets for Vue component files.
{name: 'vue-autocompile@atom.io', group: 'ui-components', link: 'https://github.com/paulpflug/vue-autocompile) - Auto compile vue file on save.
{name: 'lint-sass-vue@atom.io', group: 'ui-components', link: 'https://github.com/fsblemos/lint-sass-vue) - Atom.io package to lint Sass/SCSS in `.vue` files.
{name: 'vuejs2-snippets@atom.io', group: 'ui-components', link: 'https://github.com/CorentinAndre/Vuejs-snippets) - Atom snippets for javascript and components, including lifecycle hooks, directives, properties, vuex, vue-router, vue-i18n support.

#### Sublime Text

{name: 'Vue Syntax Highlight', group: 'ui-components', link: 'https://github.com/vuejs/vue-syntax-highlight) - Sublime Text syntax highlighting for single-file Vue components.
{name: 'VUEFormatter', group: 'ui-components', link: 'https://github.com/baixuexiyang/VUEFormatter) - Sublime Text code format
{name: 'vuejs-sublime-complete', group: 'ui-components', link: 'https://github.com/BrainBuzzer/vuejs-sublime-complete) - Sublime Text code complete
{name: 'Vue Next Formatter', group: 'ui-components', link: 'https://github.com/luozhihua/sublime-vue-formatter) - Sublime Text Vue formatter, Supported ES5/6/7, Less/Sass and Pug/Html template.

#### Vim

{name: 'Vim Vue', group: 'ui-components', link: 'https://github.com/posva/vim-vue) - Syntax Highlight for Vue.js components.

#### Visual Studio Code

{name: 'Vetur', group: 'ui-components', link: 'https://github.com/octref/vetur) - Vue tooling for VSCode.

#### Visual Studio

{name: 'VuePack', group: 'ui-components', link: 'https://github.com/madskristensen/VuePack) - Contains HTML Intellisense and code snippets for the Vue.js JavaScript library.

#### Brackets

{name: 'Brackets Vue', group: 'ui-components', link: 'https://github.com/pandao/brackets-vue) - Brackets extension for Vue.js.

#### Intellij

{name: 'Vue.js Plugin', group: 'ui-components', link: 'https://github.com/postalservice14/vuejs-plugin) - Vue.js features for the Intellij Platform (WebStorm, RubyMine, Intellij, etc).
{name: 'Vue.js support for WebStorm', group: 'ui-components', link: 'https://github.com/JetBrains/intellij-plugins/tree/master/vuejs), IntelliJ IDEA, PhpStorm, PyCharm & RubyMine – official Vue.js support by JetBrains

#### Emacs

{name: 'Vue Mode', group: 'ui-components', link: 'https://github.com/CodeFalling/vue-mode) - Emacs major mode for vue.js.

#### Kate

{name: 'Kate Syntax Files', group: 'ui-components', link: 'https://github.com/mtorromeo/kate-syntax-files) - Syntax files (modified or original) for katepart (kate, kwrite, kdevelop).
...
{name: 'vue-cli', group: 'ui-components', link: 'https://github.com/vuejs/vue-cli) - Simple CLI for scaffolding Vue.js projects.
{name: 'Vue-Django', group: 'ui-components', link: 'https://github.com/NdagiStanley/vue-django) - A boilerplate to set you up in bringing the awesomeness of VueJS into a Django (Python) app.
{name: 'python-vuejs', group: 'ui-components', link: 'https://github.com/cstrap/python-vuejs) - Gluing Python web frameworks and Vue.js with a set of scripts. Basically a `vue-cli` wrapper.
{name: 'generator-vue-plugin', group: 'ui-components', link: 'https://github.com/jeneser/generator-vue-plugin) - Yeoman generator generating vue plugin.
{name: 'vue-seed', group: 'ui-components', link: 'https://github.com/dulin666/vue-seed) - vue-seed is minimal seed for those looking to get up-and-running with Vue
{name: 'nuxt-seed', group: 'ui-components', link: 'https://github.com/dulin666/nuxt-seed) - nuxt-seed is minimal seed for those looking to get up-and-running with Vue and Nuxt
{name: 'rails_vue_melt', group: 'ui-components', link: 'https://github.com/midnightSuyama/rails_vue_melt) - Rails view with webpack=vue optimizer.
{name: 'vue-starter', group: 'ui-components', link: 'https://github.com/rohitkrai03/vue-starter) - A Vue.js starter kit that lets you focus on more programming and less configuration.
{name: 'vue-standalone-component', group: 'ui-components', link: 'https://github.com/InCuca/vue-standalone-component) - A standalone component generator with documentation support using jsdoc and vue-styleguidist

### Client

*Render Vue application in the browser only*

{name: 'Vue Plugin Boilerplate', group: 'ui-components', link: 'https://github.com/kazupon/vue-plugin-boilerplate) - Boilerplate for Vue.js plugin.
{name: 'Bourgeon', group: 'ui-components', link: 'https://github.com/rayfranco/bourgeon) - Bourgeon is an opinionated-featured VueJS 2.0 setup for Webpack.
{name: 'VuePack', group: 'ui-components', link: 'https://github.com/egoist/vuepack) - A modern starter which uses Vue 2, Vuex, Vue-router and Webpack 2 (and even Electron).
{name: 'Vue Settler', group: 'ui-components', link: 'https://github.com/weavingbird/vue-settler) - An opinionated Vue 2.0 SPA Starter.
{name: 'vue-build', group: 'ui-components', link: 'https://github.com/brianvoe/vue-build) - Ultra Simple, Development, Testing and Production Build Cli.
{name: 'Vue Element Starter', group: 'ui-components', link: 'https://github.com/Metnew/vue-element-starter) - Robust Vue 2 starter with Element-UI.
{name: 'vue-multiple-pages', group: 'ui-components', link: 'https://github.com/Plortinus/vue-multiple-pages) - A modern Vue.js multiple pages starter which uses Vue 2, Webpack2, and Element-UI
{name: 'vue-typescript-boilerplate', group: 'ui-components', link: 'https://github.com/twcapps/vue-typescript-boilerplate) - A Vue.js typescript SPA starter with Vue 2, Vue Typed, Vuex, Vue Router and localization
{name: 'vue-tachyons-template', group: 'ui-components', link: 'https://github.com/colorful-tones/vue-tachyons-template) - A Vue 2 project starter template w/ Tachyons, Webpack, and ESLint
{name: 'Vuets', group: 'ui-components', link: 'https://github.com/AkiraLaine/Vuets) - A Vue, TypeScript ready boilerplate using class-style components, vue plugin options, webpack & vue-cli.
{name: 'MMF-FE/vue-typescript', group: 'ui-components', link: 'https://github.com/MMF-FE/vue-typescript) - A vue2.x typescript template.
{name: 'Friendly Vue Starter', group: 'ui-components', link: 'https://github.com/mcongy/friendly-vue-starter) - A full featured Vue.js starter project with GraphQL support via Apollo-client (Vuex, Vue-router, Vue-i18n, Webpack 3, Eslint, Prettier, ...)
{name: 'vue-webpack-typescript', group: 'ui-components', link: 'https://github.com/ducksoupdev/vue-webpack-typescript) - A Vue 2.2 Webpack 2 and Typescript 2 setup with hot reload, unit testing, code coverage, sass and bundling/minification.
{name: 'vue-ts-amd', group: 'ui-components', link: 'https://github.com/Micene09/vue-ts-amd) - A full-featured Vue.js 2 boilerplate using AMD pattern (RequireJS) and Typescript.
{name: '**vue-2-boilerplate**', group: 'ui-components', link: 'https://github.com/petervmeijgaard/vue-2-boilerplate) - Vue 2 boilerplate for developing medium to large single page applications by [petervmeijgaard', group: 'ui-components', link: 'https://github.com/petervmeijgaard/)
{name: 'layout', group: 'ui-components', link: 'https://github.com/ktquez/layout) - A full-featured Webpack + Vue Extend layout
{name: 'layout-simple', group: 'ui-components', link: 'https://github.com/ktquez/layout-simple) - A simple Webpack + Vue Extend layout

### Universal

*Render Vue application to HTML on the server and to the DOM in the browser*

{name: 'SPA Starter Kit', group: 'ui-components', link: 'https://github.com/codecasts/spa-starter-kit) - A highly opinionated starter kit for building Single Page Applications with Laravel and Vue.js.
{name: 'SSR Boilerplate', group: 'ui-components', link: 'https://github.com/fenivana/vue-ssr-boilerplate) - Vue.js Server Side Rendering Boilerplate without Polluting Vuex.
{name: 'neutrino-preset-vue-static', group: 'ui-components', link: 'https://github.com/shyiko/neutrino-preset-vue-static) - A minimalistic starter kit for building static sites using Vue.js.
{name: 'Vueniverse', group: 'ui-components', link: 'https://github.com/rlindskog/vueniverse) - A fully featured, universal Vue template for user-based applications, powered by Nuxt.js and Express.

### Server

*Includes a backend boilerplate*

{name: 'Vuetober', group: 'ui-components', link: 'https://github.com/scottbedard/oc-vuetober-theme) - Single page apps with Laravel, Vue.js, and October CMS.
{name: 'Toucan', group: 'ui-components', link: 'https://github.com/mrellipse/toucan) - Boilerplate for building single page apps. Server is multi-project .Net Core solution designed around SOLID principles. Client is TypeScript 2, Vuejs 2, Vuex 2.
{name: 'vue-server-demo', group: 'ui-components', link: 'https://github.com/fritx/vue-server-demo) - Writing koa server in Vue.

### Electron

{name: 'Electron Vue', group: 'ui-components', link: 'https://github.com/SimulatedGREG/electron-vue) - An Electron & Vue.js quick start boilerplate with vue-cli scaffolding, common Vue plugins, electron-packager/electron-builder, unit/e2e testing, vue-devtools, and webpack.
{name: 'VuePack', group: 'ui-components', link: 'https://github.com/egoist/vuepack) - A modern starter which uses Vue 2, Vuex, Vue-router and Webpack 2 (and even Electron).
...
{name: 'vue-generator', group: 'ui-components', link: 'https://github.com/hjeti/vue-generator) - A CLI generator for Vue components, views and store modules.
{name: 'vue-component-generator', group: 'ui-components', link: 'https://github.com/lakb248/vue-component-generator) - A generator for vue component, supports Vue1.X and Vue2.X.
{name: 'rapydml_cmp', group: 'ui-components', link: 'https://github.com/valq7711/rapydml_cmp) - Vue-component pythonic generator, built on top of RapydML & RapydScript.

## Runtime

### Command Line / Terminal
{name: 'blessed-vue', group: 'ui-components', link: 'https://github.com/lyonlai/blessed-vue) - A VueJS runtime to let you write command line UI in Vue Edit
...
[![CC0', group: 'ui-components', link: 'https://i.creativecommons.org/p/zero/1.0/88x31.png)', group: 'ui-components', link: 'https://creativecommons.org/publicdomain/zero/1.0/)
